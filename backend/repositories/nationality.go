...
func (r nationalityRepository) GetAll() map[string]string {
	return r.nationalityMap
}

func (r nationalityRepository) IsCodePresent(code string) bool {
	if _, ok := r.nationalityMap[code]; ok {
		return true
	}
	return false
}

func (r *nationalityRepository) setUpData() {
	// https://en.wikipedia.org/wiki/ISO_3166-1
	r.nationalityMap = map[string]string{
		"AF": "Afghanistan",
		"AX": "Åland Islands",
		"AL": "Albania",
		"DZ": "Algeria",
